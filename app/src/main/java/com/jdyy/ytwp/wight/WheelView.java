...
import com.jdyy.ytwp.adapters.WheelViewAdapter;
...
//			0xffffff, 0xffffff };
	...
	// Wheel drawables
	private int wheelBackground = R.color.colorPrimary;
	private int wheelForeground = R.color.black;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.ninecolor));
		// 设置线宽
