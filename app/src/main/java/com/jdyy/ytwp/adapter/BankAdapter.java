...
//        选中那个，改变那个的颜色
        if (position == mSelect) {
            mHolder.mTvBankName.setTextColor(mContext.getResources().getColor(R.color.dl_bg));
            mHolder.mTvBankCost.setTextColor(mContext.getResources().getColor(R.color.dl_bg));
        } else {
            mHolder.mTvBankName.setTextColor(mContext.getResources().getColor(R.color.ccolor));
            mHolder.mTvBankCost.setTextColor(mContext.getResources().getColor(R.color.ccolor));
        }
        return convertView;
    }
