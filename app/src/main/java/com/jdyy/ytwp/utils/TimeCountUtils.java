...
public class TimeCountUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        //设置按钮为灰色，这时是不能点击的
        btn.setBackground(mActivity.getResources().getDrawable(R.drawable.dl_btn_bg));
    ...
    public void onFinish() {
        ...
        btn.setBackground(mActivity.getResources().getDrawable(R.drawable.dl_btn_bg));//还原背景色
    }
